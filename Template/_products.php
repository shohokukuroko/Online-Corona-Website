        ...
        <div class="row">
            ...
            <div class="col-sm-6 py-5">
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        <td>You Save:</td>
                        <td><span class="font-size-16 text-danger">$42.00</span></td>
                    </tr>
                </table>
                <!---    !product price       -->
                ...
                <div class="size my-3">
                    ...
                    <div class="d-flex justify-content-between w-75">
                        <div class="font-rubik border p-2">
                            <button class="btn p-0 font-size-14">4 metres</button>
                        </div>
                        <div class="font-rubik border p-2">
                            <button class="btn p-0 font-size-14">10 metres</button>
                        </div>
                        <div class="font-rubik border p-2">
                            <button class="btn p-0 font-size-14">12 metres</button>
                        </div>
                    </div>
                </div>
                <!-- !size -->
